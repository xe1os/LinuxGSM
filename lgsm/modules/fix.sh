...
apply_pre_start_fix=(arma3 armar ark av bt bo csgo cs2 cmw dst hw ins kf nmrih onset pvr ro rust rw samp sdtd sfc sm sof2 squad st tf2 terraria ts3 mcb mta unt vh wurm xnt zmr)
